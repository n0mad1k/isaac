...
async def import_plant(
    ...
    plant = Plant(
        ...
        water_schedule=data.get("water_schedule"),
        fertilize_schedule=data.get("fertilize_schedule"),
        prune_frequency=data.get("prune_frequency"),
        prune_months=data.get("prune_months"),
        produces_months=data.get("produces_months"),
        harvest_frequency=data.get("harvest_frequency"),
        how_to_harvest=data.get("how_to_harvest"),
        uses=data.get("uses"),
