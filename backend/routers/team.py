...
from models.team import (
    ...
    MemberMilestone,
    # Worker visit tracking
    WorkerStandardTask, WorkerVisit, WorkerVisitTask, VisitStatus
)
...
@router.get("/members/{member_id}/standard-tasks/")
async def get_standard_tasks(
    ...
    result = await db.execute(
        ...
        .where(WorkerStandardTask.member_id == member_id, WorkerStandardTask.is_active == True)
...
@router.post("/members/{member_id}/standard-tasks/")
...
@router.put("/members/{member_id}/standard-tasks/{task_id}/")
async def update_standard_task(
    ...
    result = await db.execute(
        select(WorkerStandardTask)
        .where(WorkerStandardTask.id == task_id, WorkerStandardTask.member_id == member_id)
    )
...
@router.delete("/members/{member_id}/standard-tasks/{task_id}/")
...
@router.post("/members/{member_id}/standard-tasks/reorder/")
...
@router.get("/members/{member_id}/visits/")
async def get_worker_visits(
    ...
    query = select(WorkerVisit).where(WorkerVisit.member_id == member_id)
    if not include_completed:
...
@router.get("/members/{member_id}/visits/current/")
async def get_current_visit(
    ...
    result = await db.execute(
        select(WorkerVisit)
        .where(
            WorkerVisit.member_id == member_id,
...
@router.post("/members/{member_id}/visits/{visit_id}/tasks/")
async def add_visit_task(
    ...
    result = await db.execute(
        select(WorkerVisit)
        .where(WorkerVisit.id == visit_id, WorkerVisit.member_id == member_id)
    )
    visit = result.scalar_one_or_none()
    if not visit:
...
@router.put("/members/{member_id}/visits/{visit_id}/tasks/{task_id}/")
...
@router.delete("/members/{member_id}/visits/{visit_id}/tasks/{task_id}/")
...
@router.post("/members/{member_id}/visits/{visit_id}/tasks/reorder/")
...
@router.post("/members/{member_id}/visits/{visit_id}/complete/")
...
@router.post("/members/{member_id}/visits/{visit_id}/duplicate/")
