...
// Catches render errors from lazy-loaded pages so they show an error message
    ...
    if (this.state.hasError) {
      return (
        <div className="p-8 text-center space-y-3">
          <p className="text-lg font-semibold" style={{ color: 'var(--color-error-500)' }}>
        ...
        <Suspense fallback={<PageLoader />}>
          <Routes>
            ...
            >
              ...
              <Route path="todo" element={<Navigate to="/lists" replace />} />
