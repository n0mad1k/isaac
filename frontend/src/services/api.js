...
export const getTodaysTasks = (listId) => api.get('/tasks/today/', { params: listId ? { list_id: listId } : {} })
export const getUpcomingTasks = (days = 7, listId) =>
  api.get('/tasks/upcoming/', { params: { days, ...(listId ? { list_id: listId } : {}) } })
export const getOverdueTasks = (listId) => api.get('/tasks/overdue/', { params: listId ? { list_id: listId } : {} })
...
export const testMonthlyPlantingDigest = () => api.post('/settings/test-monthly-planting-digest/')
...
export const getBudgetCycleConfig = () => api.get('/budget/cycle-config/')
export const updateBudgetCycleConfig = (data) => api.post('/budget/cycle-config/', data)
