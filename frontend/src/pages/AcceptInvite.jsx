    ...
    return (
      <div className="min-h-screen bg-surface-app flex items-center justify-center p-4">
        <div className="bg-surface rounded-xl p-8 max-w-md w-full text-center">
          ...
          <a
            href="/"
            className="inline-block px-6 py-2 bg-surface-soft hover:bg-surface-hover rounded-lg transition-colors"
          >
            Go to Login
          </a>
        </div>
    ...
    return (
      <div className="min-h-screen bg-surface-app flex items-center justify-center p-4">
        <div className="bg-surface rounded-xl p-8 max-w-md w-full text-center">
          ...
          <p className="text-muted mb-2">Welcome to Isaac, {formData.username}!</p>
  ...
  return (
    <div className="min-h-screen bg-surface-app flex items-center justify-center p-4">
      <div className="bg-surface rounded-xl p-8 max-w-md w-full">
        ...
        {invitation && (
          <div className="bg-surface-soft/50 rounded-lg p-4 mb-6">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 bg-surface-soft border border rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500"
