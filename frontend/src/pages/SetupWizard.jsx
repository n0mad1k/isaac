    ...
    <div className="flex items-center justify-center mb-8">
      {[1, 2, 3, 4].map((s) => (
        <React.Fragment key={s}>
          ...
          {s < 4 && (
            <div className={`w-12 h-1 ${s < step ? 'bg-green-700' : 'bg-surface-soft'}`} />
          )}
        </React.Fragment>
      ))}
    </div>
  ...
  const renderStep1 = () => (
    <div className="space-y-6">
      <div className="text-center mb-6">
        ...
        <p className="text-muted">Let's set up your farm management system</p>
      </div>
      ...
      <div>
        ...
        <input
          ...
          className="w-full px-4 py-3 bg-surface-soft border border rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-farm-green"
  ...
  const renderStep2 = () => (
    <div className="space-y-6">
      <div className="text-center mb-6">
        ...
        <p className="text-muted">Set up your administrator login</p>
      </div>
  ...
  const renderStep3 = () => (
    <div className="space-y-6">
      <div className="text-center mb-6">
        ...
        <p className="text-muted">Select which features you want to use</p>
      </div>
          ...
          <button
            ...
            className={`p-4 rounded-lg border text-left transition-colors ${
              formData.enabled_modules.includes(key)
                ...
                : 'bg-surface-soft border hover:border-strong'
          ...
          >
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-sm text-muted mt-1">{module.description}</div>
              </div>
            </div>
          </button>
        ))}
  ...
  const renderStep4 = () => (
    <div className="space-y-6">
      <div className="text-center mb-6">
        ...
        <p className="text-muted">Configure these later in Settings if needed</p>
      </div>
      ...
      <div className="bg-surface-soft/50 rounded-lg p-4">
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 bg-surface-soft border border rounded-lg text-white text-sm focus:outline-none focus:ring-2 focus:ring-farm-green"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm text-muted mb-1">Username/Email</label>
              <input
                type="email"
          ...
          <div>
            <label className="block text-sm text-muted mb-1">Send Alerts To (Optional)</label>
            <input
              type="email"
      ...
      <div className="bg-surface-soft/50 rounded-lg p-4">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm text-muted mb-1">CalDAV Username <span className="text-red-400">*</span></label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-sm text-muted mb-1">CalDAV Password <span className="text-red-400">*</span></label>
              <input
                type="password"
      ...
      <div className="bg-surface-soft/50 rounded-lg p-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            <label className="block text-sm text-muted mb-1">Application Key</label>
            <input
              type="text"
          ...
          <div className="bg-surface rounded-xl p-8 shadow-xl">
            ...
            <div className="flex justify-between mt-8">
              {step > 1 ? (
                <button
                  onClick={prevStep}
                  className="px-6 py-3 bg-surface-soft hover:bg-surface-hover rounded-lg font-medium text-white transition-colors flex items-center gap-2"
                >
              ...
              {step < 4 ? (
                ...
                <button
                  ...
                  disabled={loading}
                  className="px-8 py-3 bg-farm-green hover:bg-farm-green-light disabled:bg-surface-hover disabled:cursor-not-allowed rounded-lg font-medium text-white transition-colors flex items-center gap-2"
                >
                  {loading ? (
                    <>
